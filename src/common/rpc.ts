...
export const ETH_RPC_SOCKET = [
  // ['wss://mainnet.infura.io/ws/v3/c99a5e7d69004c0f9974f106b6b919fb', 'infura'],
  ['wss://eth-mainnet.g.alchemy.com/v2/AWLrYSVH0FAsnC1n2lBjOX16ln3TpEia', 'alchemy'],
];
...
export const BSC_RPC_MAINNET = [
  ...
  ['https://rpc.coinsdo.com/bsc', 'coinsdo'],
  ['https://rpc.ankr.com/bsc', 'ankr'],
  ['https://bsc-dataseed1.binance.org/', 'bsc-dataseed1'],
  ['https://bsc-dataseed2.binance.org/', 'bsc-dataseed2'],
  ['https://bsc-dataseed3.binance.org/', 'bsc-dataseed3'],
  ['https://bsc-dataseed4.binance.org/', 'bsc-dataseed4'],
  ['https://bsc-dataseed1.defibit.io/', 'bsc-dataseed1.defibit.io'],
  ['https://bsc-dataseed2.defibit.io/', 'bsc-dataseed2.defibit.io'],
  ['https://bsc-dataseed3.defibit.io/', 'bsc-dataseed3.defibit.io'],
  ['https://bsc-dataseed4.defibit.io/', 'bsc-dataseed4.defibit.io'],
  ['https://bsc-dataseed1.ninicoin.io/', 'bsc-dataseed1.ninicoin.io'],
  ['https://bsc-dataseed2.ninicoin.io/', 'bsc-dataseed2.ninicoin.io'],
  ['https://bsc-dataseed3.ninicoin.io/', 'bsc-dataseed3.ninicoin.io'],
  ['https://bsc-dataseed4.ninicoin.io/', 'bsc-dataseed4.ninicoin.io'],
  // ['https://bscrpc.com', 'bscrpc'],
  // ['https://rpc.ankr.com/bsc', 'ankr'],
