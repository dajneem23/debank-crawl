...
export class migration1659597507732 implements MigrationInterface {
    name = 'migration1659597507732'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            CREATE TYPE "public"."event_type_enum" AS ENUM('online', 'offline', 'virtual')
        `);
        await queryRunner.query(`
            CREATE TABLE "event" (
                "id" uuid NOT NULL DEFAULT uuid_generate_v4(),
        ...
        `);
        await queryRunner.query(`
            CREATE TABLE "event_crypto_asset_tags" (
                "event_id" uuid NOT NULL,
                "crypto_asset_tag_id" uuid NOT NULL,
                CONSTRAINT "PK_f5ae841afe14b50218b42124953" PRIMARY KEY ("event_id", "crypto_asset_tag_id")
            )
        `);
        await queryRunner.query(`
            CREATE INDEX "IDX_3fc511c61ce2cf41ec8cfdcfb7" ON "event_crypto_asset_tags" ("event_id")
        `);
        await queryRunner.query(`
            CREATE INDEX "IDX_fdf3ef8926bee88b16c1beb01c" ON "event_crypto_asset_tags" ("crypto_asset_tag_id")
        `);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "event_crypto_asset_tags"
            ADD CONSTRAINT "FK_3fc511c61ce2cf41ec8cfdcfb7b" FOREIGN KEY ("event_id") REFERENCES "event"("id") ON DELETE CASCADE ON UPDATE CASCADE
        `);
        await queryRunner.query(`
            ALTER TABLE "event_crypto_asset_tags"
            ADD CONSTRAINT "FK_fdf3ef8926bee88b16c1beb01c0" FOREIGN KEY ("crypto_asset_tag_id") REFERENCES "crypto_asset_tag"("id") ON DELETE CASCADE ON UPDATE CASCADE
        `);
        await queryRunner.query(`
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "event_crypto_asset_tags" DROP CONSTRAINT "FK_fdf3ef8926bee88b16c1beb01c0"
        `);
        await queryRunner.query(`
            ALTER TABLE "event_crypto_asset_tags" DROP CONSTRAINT "FK_3fc511c61ce2cf41ec8cfdcfb7b"
        `);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`
            DROP INDEX "public"."IDX_fdf3ef8926bee88b16c1beb01c"
        `);
        await queryRunner.query(`
            DROP INDEX "public"."IDX_3fc511c61ce2cf41ec8cfdcfb7"
        `);
        await queryRunner.query(`
            DROP TABLE "event_crypto_asset_tags"
        `);
        await queryRunner.query(`
