...
export class DebankService {
  ...
  private readonly jobs: {
    ...
    'debank:crawl:portfolio:list': this.crawlPortfolioByListV2,
        ...
        async (user_address) => {
          ...
          try {
            ...
            const [_, cache_balance_list, project_list] = await Promise.all([
              page
                .goto(`https://debank.com/profile/${user_address}`, {
                  waitUntil: 'load',
                  timeout: 2 * 60 * 1000,
                })
                .then(() => {
                  ...
                  // page.goto(`https://api.debank.com/portfolio/project_list?user_addr=${addr}`, {
                  //   waitUntil: 'load',
                  //   timeout: 2 * 60 * 1000,
                  // });
                }),
